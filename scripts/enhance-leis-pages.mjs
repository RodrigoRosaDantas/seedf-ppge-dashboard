...
function cssLink(prefix) { return `<link rel="stylesheet" href="${prefix}leis-enhanced.css?v=20260925d">`; }
function readerCssLink(prefix) { return `<link rel="stylesheet" href="${prefix}reading-preferences.css?v=20260925d">`; }
