...
<footer class="study-footer">SEEDF PPGE · leitura principal no site · fallback: Notion · conteúdo sincronizado em ${escapeHtml(formatDate(snapshot.source?.synced_at))}</footer>
</main></body></html>`;
}
...
<section class="laws-hero"><div class="laws-hero-copy"><p class="laws-kicker">⚖️ TRILHA OPERACIONAL · SEEDF PPGE</p><h1>Leis Primeiro</h1><p class="laws-lead">As páginas L01–L34 hospedam a leitura dentro do próprio site. Se o site estiver indisponível, use o Notion como plano B; para validade jurídica, o texto oficial vigente prevalece.</p><div class="laws-hero-actions"><a class="laws-primary" href="#leis">Abrir primeira lei no site ↓</a><a class="laws-secondary" href="${escapeHtml(snapshot.source?.page_url || "#")}" target="_blank" rel="noreferrer">Registro vivo · Notion ↗</a></div></div><div class="laws-hero-card"><div class="laws-seal">✓</div><div><span>Páginas internas</span><strong>${laws.length} leis</strong><small>L01–L34 · navegação anterior/próxima</small></div></div></section>
