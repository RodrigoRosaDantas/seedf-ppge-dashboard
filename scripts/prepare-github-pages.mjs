...
function buildLawCard(law) {
  ...
  const actions = [
    ...
    law.notion_url ? `<a href="${escapeHtml(law.notion_url)}" target="_blank" rel="noreferrer">Plano B · Notion ↗</a>` : "",
  ].join("");
...
<div class="study-actions"><a class="primary" href="#study-content">📖 Ler no site</a>${law.official_url ? `<a href="${escapeHtml(law.official_url)}" target="_blank" rel="noreferrer">Fonte oficial ↗</a>` : ""}${law.notion_url ? `<a href="${escapeHtml(law.notion_url)}" target="_blank" rel="noreferrer">Plano B · Notion ↗</a>` : ""}${law.bank_record_url ? `<a href="${escapeHtml(law.bank_record_url)}" target="_blank" rel="noreferrer">Registro operacional ↗</a>` : ""}</div>
